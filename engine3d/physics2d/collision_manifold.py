...
from engine3d.physics2d.collision_bool import aabb_overlap_2d
...
def capsule_vs_circle_manifold(capsule, circle) -> Optional[CollisionManifold2D]:
    from engine3d.physics2d.geometry import closest_point_on_segment
...
def polygon_vs_circle_manifold(poly_collider, circle_collider) -> Optional[CollisionManifold2D]:
    from engine3d.physics2d.geometry import polygon_axes as _poly_axes, project_polygon_onto_axis
...
def polygon_vs_obb_manifold(poly_collider, obb_collider) -> Optional[CollisionManifold2D]:
    from engine3d.physics2d.geometry import polygon_axes as _poly_axes, project_polygon_onto_axis
    from engine3d.physics2d.collision_bool import _obb_corners, _obb_axes
