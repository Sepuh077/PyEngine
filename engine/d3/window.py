...
class Window3D(WindowBase):
    ...
    # Default pipeline GLSL (see engine.d3.shaders)
    VERTEX_SHADER = VERTEX_SHADER
    VERTEX_SHADER_INSTANCED = VERTEX_SHADER_INSTANCED
    FRAGMENT_SHADER = FRAGMENT_SHADER
    COLLIDER_VERTEX_SHADER = COLLIDER_VERTEX_SHADER
    COLLIDER_FRAGMENT_SHADER = COLLIDER_FRAGMENT_SHADER
    SHADOW_VERTEX_SHADER = SHADOW_VERTEX_SHADER
    SHADOW_VERTEX_SHADER_INSTANCED = SHADOW_VERTEX_SHADER_INSTANCED
